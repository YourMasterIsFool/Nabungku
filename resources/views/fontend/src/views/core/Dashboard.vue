            ...
            <sidebar-vue class="bg-white col-span-3 p-8 text-xs">
                <template v-slot:content>
                    <div class="flex flex-col relative">
                        ...
                        <div ref="subCategoryDetail"  v-if="$store.state.modal.showSubCategoryDetail" :class="" class=" mt-4 md:mt-8 relative  bg-gray w-full h-full">
    ...
    methods: {
        ...
        fetchCategory(budget_id) {
            ...
            this.fetchCategoryData(budget_id).then(res => {
              console.log('fethcing data' , this.category);  
            });
